...
impl ::std::str::FromStr for ProgressToken {
    ...
    fn from_str(value: &str) -> ::std::result::Result<Self, self::error::ConversionError> {
        ...
        let string_result: ::std::result::Result<String, _> = value.parse();
        match string_result {
            Ok(v) => Ok(Self::String(v)),
            Err(_) => {
                // Then try to parse as Integer
                let int_result: ::std::result::Result<i64, _> = value.parse();
                match int_result {
...
#[doc = r" ```"]
#[doc = r" </details>"]
// Note: Using jsoncall::RequestId instead of defining our own RequestId enum\n// This ensures compatibility with the JSON-RPC 2.0 library\n// All RequestId implementations are provided by jsoncall::RequestId
#[derive(:: serde :: Deserialize, :: serde :: Serialize, Clone, Debug)]
#[derive(Default)]
...
pub mod builder {
    ...
    pub struct JsonrpcMessage {
        subtype_0: ::std::result::Result<
            ::std::option::Option<super::JsonrpcRequest>,
            ::std::string::String,
        >,
        subtype_1: ::std::result::Result<
            ::std::option::Option<super::JsonrpcNotification>,
            ::std::string::String,
        >,
        subtype_2: ::std::result::Result<
            ::std::option::Option<::std::vec::Vec<super::JsonrpcMessageSubtype2Item>>,
            ::std::string::String,
        >,
        subtype_3: ::std::result::Result<
            ::std::option::Option<super::JsonrpcResponse>,
            ::std::string::String,
        >,
        ...
        subtype_5: ::std::result::Result<
            ::std::option::Option<::std::vec::Vec<super::JsonrpcMessageSubtype5Item>>,
            ::std::string::String,
        >,
    }
    ...
    impl JsonrpcMessage {
        ...
        where
            T: ::std::convert::TryInto<::std::option::Option<super::JsonrpcRequest>>,
            T::Error: ::std::fmt::Display,
        {
        ...
        where
            T: ::std::convert::TryInto<::std::option::Option<super::JsonrpcNotification>>,
            T::Error: ::std::fmt::Display,
        {
        ...
        where
            T: ::std::convert::TryInto<::std::option::Option<super::JsonrpcResponse>>,
            T::Error: ::std::fmt::Display,
        {
    ...
    impl ::std::convert::TryFrom<RequestParams> for super::PingRequestParams {
        type Error = super::error::ConversionError;
        fn try_from(
            value: RequestParams,
        ) -> ::std::result::Result<Self, super::error::ConversionError> {
            let meta_value = value.meta?;
            let ping_meta = meta_value.map(|m| super::PingRequestParamsMeta {
                progress_token: m.progress_token,
            });
            Ok(Self { meta: ping_meta })
        }
    }
    impl ::std::convert::From<super::PingRequestParams> for RequestParams {
        fn from(value: super::PingRequestParams) -> Self {
            let request_meta = value.meta.map(|m| super::RequestParamsMeta {
                progress_token: m.progress_token,
            });
            Self {
                meta: Ok(request_meta),
            }
        }
    }
    #[derive(Clone, Debug)]
